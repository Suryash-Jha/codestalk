...
class userDetails(models.Model):
    ...
    id_codeforces = models.CharField(max_length=100, default="No_id")
    id_codechef = models.CharField(max_length=100, default="No_id")
    id_leetcode = models.CharField(max_length=100, default="No_id")
    id_gfg = models.CharField(max_length=100, default="No_id")
    id_hackkerank = models.CharField(max_length=100, default="No_id")
